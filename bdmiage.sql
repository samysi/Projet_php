...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 13 mai 2020 à 01:00
...
(19, 'cv_12.pdf', 'lettre_motivation_12.pdf', 'relever_note_12.pdf', 'imprime_ecran_12.pdf', 12, 2, 3, 'Prenez moi !!!!');
...
--
ALTER TABLE `dossiers`
  MODIFY `id_dossier` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
