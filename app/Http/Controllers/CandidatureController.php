...
class CandidatureController extends Controller
{
    ...
    // Verifie si le candidat à déjà postuler et est rediriger vers la page validation
    ...
    // Dans le cas ou le statut cette fonction de déposer une nouvelle fois le dossier
